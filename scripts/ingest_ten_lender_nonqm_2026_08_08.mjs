...
export const SOURCES = {
  ...
  hometownNqm: "https://wholesale.thelender.com/wp-content/uploads/2026/08/Non-QHEM_08.04.26E.pdf",
...
const hometownBase = { maxLoanAmount: 4000000, minFico: 620, baseMaxLtv: 90, maxDti: 50, minReservesMonths: 0, citizenshipLtvCaps: { non_permanent_resident: 85 }, notes: "Non-QHEM matrix dated 2026-08-04 is superseded by the dedicated complete theLender ingestion that runs immediately after this compatibility pass." };
const hometownPrograms = [
  record("theLender", "Non-QHEM — Full Documentation", SOURCES.hometownNqm, "Non-QHEM 2026-08-04E", "2026-08-04", base(hometownBase)),
  ...altDocVariants({ lender: "theLender", family: "Non-QHEM", source: SOURCES.hometownNqm, version: "Non-QHEM 2026-08-04E", date: "2026-08-04", periods: [12,24], includeWvoe: true, familyConfig: hometownBase }),
  record("theLender", "Non-QHEM — P&L Plus", SOURCES.hometownNqm, "Non-QHEM 2026-08-04E", "2026-08-04", base({ ...hometownBase, incomeDocTypes: ["pnl_only"], pnlTaxReturnsRequired: false, pnlPreparerAttestationPurpose: "confirms_tax_filing_only", pnlSupportingBankStatementsMonths: 3, notes: "P&L plus three months supporting statements; support must be within 10% of P&L income." })),
...
async function resolveLenders(admin, adminId) {
  const aliases = new Map([
    ...
    ["theLender", ["hometownequitymortgage","thelender"]],
