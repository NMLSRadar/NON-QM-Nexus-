// Batch 4 lender ingestion — see scripts/batch4-data.mjs for the
// rationale, real guideline data, and disclosed exclusions. Resolves the
// real admin explicitly by email (the same fix applied to batch 3's
// script, after that batch's org-resolution bug).
import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "node:fs";
import { LENDERS } from "./batch4-data.mjs";
