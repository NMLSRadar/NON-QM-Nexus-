...
export const LENDER_WORDMARK_STYLES: Record<string, LenderWordmarkStyle> = {
  ...
  "AmWest Funding Corp.": { first: "AmWest", second: "Funding Corp.", firstColor: "#1E3A8A", secondColor: "#6B7280" },
  "Angel Oak Mortgage Solutions": { first: "Angel Oak", second: "Mortgage Solutions", firstColor: "#1D4ED8", secondColor: "#1D4ED8" },
  ARDRI: { first: "ARDRI", second: "", firstColor: "#0F766E", secondColor: "#0F766E" },
  "BluePoint Mortgage": { first: "BluePoint", second: "Mortgage", firstColor: "#2563EB", secondColor: "#6B7280" },
  "Cake Mortgage": { first: "Cake", second: "Mortgage", firstColor: "#C2410C", secondColor: "#6B7280" },
  ...
  "ClearEdge Lending": { first: "ClearEdge", second: "Lending", firstColor: "#0369A1", secondColor: "#6B7280" },
  ...
  "Logan Finance Corporation": { first: "Logan Finance", second: "Corporation", firstColor: "#1E293B", secondColor: "#6B7280" },
  ...
  "Oaktree Funding Corporation": { first: "Oaktree", second: "Funding Corporation", firstColor: "#166534", secondColor: "#6B7280" },
  ...
  "United Wholesale Mortgage": { first: "United Wholesale", second: "Mortgage", firstColor: "#1E3A8A", secondColor: "#6B7280" },
