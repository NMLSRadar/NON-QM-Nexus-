...
const assetSchema = z.object({ checking: z.number().nonnegative(), brokerage: z.number().nonnegative(), stocks: z.number().nonnegative(), retirement: z.number().nonnegative(), vested: z.number().min(0).max(100), down: z.number().nonnegative(), costs: z.number().nonnegative(), reserves: z.number().nonnegative(), divisor: z.number().positive() }).strict();
