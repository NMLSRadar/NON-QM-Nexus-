...
const TOOLS: Array<{ id: ToolId; title: string; description: string; icon: typeof Calculator; badge: string }> = [
  { id: "reverse-solver", title: "VIQI — Voice Instant Qualifier Interface", description: "How much house can this borrower buy?", icon: ChartNoAxesCombined, badge: "Flagship" },
